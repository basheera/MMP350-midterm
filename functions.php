...
function sampletheme_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'sampletheme' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'sampletheme_custom_background_args', array(
...
function sampletheme_scripts() {
	...
	wp_enqueue_script( 'sampletheme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'sampletheme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
...
// Custom Function Vans (Create Footer)
...
function createFooter(){
	...
	echo '<footer id=vansFooter>';
	
	echo '<p> Vans Fan Club';
